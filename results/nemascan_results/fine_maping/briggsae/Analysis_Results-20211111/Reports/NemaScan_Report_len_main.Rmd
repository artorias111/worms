...
processed_mapping <- read.delim("processed_len_AGGREGATE_mapping.tsv", stringsAsFactors=FALSE) %>%
...
for (i in seq_len(nrow(QTL_peaks))) { 
    ...
    out <- c(out, knitr::knit_child('NemaScan_Report_region_len.Rmd'))
}
